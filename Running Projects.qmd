...
::: {.project-card}
### Plasma Protein Biomarker for Cancer Screening
Using mass spectrometry–based plasma proteomics to discover and validate circulating protein biomarkers for early colorectal cancer detection. By integrating proteomic, genetic, and clinical data, this project enhances non-invasive early-detection tools.
:::
...
Quantifying the global lifetime risk and preventable incidence of colorectal cancer attributable to modifiable risk factors (2022–2050) across 185 countries, using comparative modeling to guide international prevention policies.
:::
